...
g_view.cli_view(data,"basic-result")
...
g_view.cli_view(data,"create-site-result")
...
g_view.cli_view(data,"basic-result-creds")
...
#image-copy
data = [{u'thread_id': 5}]
g_view.cli_view(data,"image-operation")
...
g_view.cli_view(data,"get-image")
